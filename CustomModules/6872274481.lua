...
local function vapeGithubRequest(scripturl)
	if not isfile("vape/"..scripturl) then
		local suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/SAH19DHSAUDHA9/CattoWare4Roblox/"..readfile("vape/commithash.txt").."/"..scripturl, true) end)
		assert(suc, res)
	...
	task.spawn(function()
		pcall(function()
			...
			if not isfile("vape/Profiles/bedwarsdata.txt") then 
				local commit = "main"
				for i,v in pairs(game:HttpGet("https://github.com/SAH19DHSAUDHA9/CattoWare4Roblox"):split("\n")) do 
				...
				writefile("vape/Profiles/bedwarsdata.txt", game:HttpGet("https://raw.githubusercontent.com/7GrandDadPGN/CattoWare4Roblox/"..commit.."/CustomModules/bedwarsdata", true))
			end
			local olddata = readfile("vape/Profiles/bedwarsdata.txt")

			repeat
				local commit = "main"
				for i,v in pairs(game:HttpGet("https://github.com/7GrandDadPGN/CattoWare4Roblox"):split("\n")) do 
					if v:find("commit") and v:find("fragment") then 
						local str = v:split("/")[5]
						commit = str:sub(0, str:find('"') - 1)
						break
				...
				local newdata = game:HttpGet("https://raw.githubusercontent.com/7GrandDadPGN/CattoWare4Roblox/"..commit.."/CustomModules/bedwarsdata", true)
